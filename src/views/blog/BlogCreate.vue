      ...
      <div class="row mt-1">
        <div class="col">
          <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
              ...
              <div class="row mt-3">
                <div class="col-12 col-md-6 col-lg-6 col-xl-6 mb-2">
                  <div class="form-group">
                    ...
                    <input v-model="formData.title" placeholder="Title" type="text" class="form-control">
                  </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 col-xl-6 mb-2">
            ...
            <QuotaFullCard quotacode="blog" @inSubscription="inSubscription=$event"></QuotaFullCard>
          </div>
        </div>
      </div>
    </ion-content>
...
function refetch() {
  ...
  axios.post<PaginatedApiResponse>(endpoints.blog.category.index, {
    status:"active"
  }, {
...
async function submit() {
  ...
  const tags = formData.tags ? JSON.parse(formData.tags).map(o => o.value) : null;
  let fd = new FormData()
  let consol_=[]
  consol_.push(tags)
  fd.append("title", formData.title)
  if (tags) {
    tags.forEach((item: any) => fd.append("tags", item))
  }
  ...
  await axios.post<PaginatedApiResponse>(endpoints.blog.create, fd, {
    headers: pitLib.util.headers(),
  }).then(d => {
