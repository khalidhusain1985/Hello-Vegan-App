...
const fd = reactive({
  content: undefined, image: undefined, video: undefined
});
...
async function submit() {
  ...
  _fd.append("content", fd.content??null)
  _fd.append("image", fd.image ?? null)
  _fd.append("video", fd.video ?? null)
  _fd.append("status","approved")
  await axios.post<ApiResponse>(endpoints.veganlog.create, _fd, {
...
async function setImage() {
  pitLib.media.getBase64(fd.image).then(d=>{
...
<template>
  <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
    ...
    <div class="card-body d-flex p-0 mt-0">
      ...
      <a @click="filePicker()" class="d-flex align-items-center font-xssss fw-600 ls-1 text-grey-700 text-dark pe-4"><i class="font-md text-success feather-image me-2"></i><span class="d-none-xs">Photo</span></a>
